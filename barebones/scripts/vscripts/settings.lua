...
NORMAL_START_GOLD = 1500                 -- Starting Gold
...
--FIXED_RESPAWN_TIME = 10.0
MAX_RESPAWN_TIME = 10					-- Default Dota doesn't have a limit (it can go above 125). Fast game modes should have 20 seconds.
...
CUSTOM_RESPAWN_TIME = {}
CUSTOM_RESPAWN_TIME[0] = 0
CUSTOM_RESPAWN_TIME[1] = 10
