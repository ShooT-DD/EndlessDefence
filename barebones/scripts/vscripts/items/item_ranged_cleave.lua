...
item_ranged_cleave4 = class({})
item_ranged_cleave5 = class({})
item_ranged_cleave6 = class({})
item_ranged_cleave7 = class({})
item_ranged_cleave8 = class({})
...
function item_ranged_cleave4:GetIntrinsicModifierName()
	return "modifier_item_ranged_cleave"
end

function item_ranged_cleave5:GetIntrinsicModifierName()
	return "modifier_item_ranged_cleave"
end

function item_ranged_cleave6:GetIntrinsicModifierName()
	return "modifier_item_ranged_cleave"
end

function item_ranged_cleave7:GetIntrinsicModifierName()
	return "modifier_item_ranged_cleave"
end

function item_ranged_cleave8:GetIntrinsicModifierName()
	return "modifier_item_ranged_cleave"
end
